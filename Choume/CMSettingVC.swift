...
extension CMSettingVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 1: cell = tableView.dequeueReusableCellWithIdentifier("settingAgreementCell")
        case 2: cell = tableView.dequeueReusableCellWithIdentifier("settingAboutCell")!
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        case 0:
            ...
            break
        case 1:
            vc.setContentOrUrl("<p class=\"p1\" style=\"text-align: center;\">\n" +
                "    用户注册服务协议\n" +
                "</p>\n" +
                "<p class=\"p2\">\n" +
            ...
            break
        case 2:
            vc.setContentOrUrl("<p class=\"p1\" style=\"text-align: left;\">\n" +
