...
class CMEditingViewController: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.node = CMContext.sharedInstance.getNodes()
...
//        self.navigationController?.navigationBar.backgroundColor = UIColor.redColor()
    ...
    func configureDefaultSelectedRow() {
        if whoCalledEditingViewController == -1 { // CMViewController called me
    ...
    @IBAction func okAction(sender: AnyObject) {
        ...
        if let vc = storyboard?.instantiateViewControllerWithIdentifier(self.postControllerID) as? CMPostViewController {
...
extension CMEditingViewController: UIPickerViewDataSource {
...
extension CMEditingViewController: UIPickerViewDelegate {
