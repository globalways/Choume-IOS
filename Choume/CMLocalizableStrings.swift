...
let CMOK                       = NSLocalizedString("好的", comment: "")


let NO_MORE_DATA               = NSLocalizedString("没有更多数据了!", comment: "")
...
let YOU_HAVENOT_WROTE_ANYTHING = NSLocalizedString("You haven't wrote anything!", comment: "")
let GOT_IT                     = NSLocalizedString("Got it", comment: "")
let MESSAGES                   = NSLocalizedString("Messages", comment: "")
let NO_MESSAGE_YET             = NSLocalizedString("No message yet...", comment: "")
let FILL_IN_ALL_THE_FORM       = NSLocalizedString("You should fill in all the form", comment: "")
...
let TRY_AGAIN                  = NSLocalizedString("重试", comment: "")
...
let PASSWD_MUST_BE_THE_SAME    = NSLocalizedString("Passwords must be the same", comment: "")
let I_KNOW                     = NSLocalizedString("I know", comment: "")
let REGISTER_SUCESSFULLY       = NSLocalizedString("注册成功正在登录...", comment: "")
let REGISTER_FAILED            = NSLocalizedString("注册失败", comment: "")
let SERVER_ERROR               = NSLocalizedString("服务器错误...\n😭😭😭", comment: "")
...
let BUTTON_CHANGE_THEME        = NSLocalizedString("小明", comment: "")
let BUTTON_LOGIN               = NSLocalizedString("登录", comment: "")
let BUTTON_REGISTER            = NSLocalizedString("注册", comment: "")
...
let INSERT_UID_AND_PASSWD      = NSLocalizedString("请输入您的账号和密码", comment: "")
//let HOLDER_USERNAME            = NSLocalizedString("用户名/邮箱", comment: "")
//使用手机号登录
let HOLDER_USERNAME            = NSLocalizedString("手机号", comment: "")
let HOLDER_PASSWORD            = NSLocalizedString("密码", comment: "")
let BUTTON_OK                  = NSLocalizedString("确定", comment: "")
let BUTTON_CANCEL              = NSLocalizedString("取消", comment: "")
let ERROR_MESSAGE              = NSLocalizedString("错误信息", comment: "")
let SURE_TO_LOGOUT             = NSLocalizedString("确定要登出账户吗 ?", comment: "")
let REGISTER_OR_LOGIN          = NSLocalizedString("登录或者注册？", comment: "")
...
// 项目回报
let REWARD_HAS_NO_TITLE        = NSLocalizedString("项目回报没有标题", comment: "")
