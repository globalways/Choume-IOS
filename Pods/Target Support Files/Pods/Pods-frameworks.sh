...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/ASProgressPopUpView.framework"
  ...
  install_framework "Pods/GSKStretchyHeaderView.framework"
  install_framework "Pods/GearRefreshControl.framework"
  ...
  install_framework "Pods/RNLoadingButton_Swift.framework"
